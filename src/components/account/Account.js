...
const Account = () => {
  ...
  async function getPoolInfo (){
    try{
      ...
      let temp = ethers.utils.formatUnits(_poolInfo[2].toString(), 9).toString()
      console.log ("temp: ", temp, " value: ", _poolInfo[2].toString());
      setCurrentPoolSize(temp);
      temp = ethers.utils.formatUnits(_poolInfo[1].toString(), 9).toString()
      setMaxPoolSize(temp)
      temp = ethers.utils.formatUnits(_poolInfo[4].toString(), 18).toString()
      setTotalReward(temp);
    }catch(err){
      console.log(err);
    }
  ...
  async function getUserInfo (){
    try{
      ...
      setStackingBalance(ethers.utils.formatUnits(_userInfo[0], 9).toString())
      ...
      let _claimedReward = ethers.utils.formatUnits( _userInfo[2], 18).toString();
    ...
    <div className='container'>
      ...
      <div className='inner_block3'>
        ...
        <div className='dashboard-card'>
            ...
            <div className='card_title'>
            <h2>Token {(parseFloat(balance) + parseFloat(stakingBalance))}MMD </h2></div>
          </div>
      </div>
      <div className='inner_block3'>
        <div className='dashboard-card'>
